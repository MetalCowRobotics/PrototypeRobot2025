...
public class WristSubsystem {
    ...
    private SparkMax WristMotor = new SparkMax(19, MotorType.kBrushless);
    private SparkClosedLoopController wristClosedLoopController = WristMotor.getClosedLoopController();
    ...
    private void pushValue() {
        SmartDashboard.putNumber("Wrist Motor Speed", motorSpeed);
    ...
    public void L3_Angle() {
        targetLocation = Constants.L3_Angle;
    }

    public void L4_Angle() {
        targetLocation = Constants.L4_Angle;
    }

    public void Source_Angle() {
        targetLocation = Constants.Source_Angle;
    }

    public void Rest_Angle() {
        targetLocation = Constants.Rest_Angle;
    }
    // Equation = encoder1.GetPosition * (130.1247*(1/15)/42)
}

// // Default motor speed
// private double motorSpeed = 0.1; // Default speed, can be changed using
// setSpeed()

// // Button ID for motor activation (use an appropriate button ID)
// private static final int ACTIVATE_BUTTON = XboxController.Button.kA.value; //
// Button A
...
// private CANSparkMax = new CANSparkMax(19,
...
// // climbMotor.configure(config, ResetMode.kResetSafeParameters,
...
// // climbmotor1.configure(config1, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
...
// climbmotor1.configure(config1base, ResetMode.kResetSafeParameters,
// PersistMode.kPersistParameters);
